...
5	5	f	Johan.guerrero394@gmail.com	7110eda4d09e062aa5e4a390b0a572ac0d2c0220
\.
...
9			Armadiho	Rock Francais 	images/Armadiho.jpg
\.
...
COPY public.concertindex (id_concertindex, importance, genreconcert, lieu, dateconcert, description, prix, nbplaces, nbplaceslibres) FROM stdin;
5	0	Pop	Toulon	2018-10-28	Pas ce détails suplementaire	20	100	100
7	0	Reggae	Gironde	2019-03-28	concert en pleine air	0	1500	1500
4	0	Classique	Royan	2019-06-30	Feu d artifice à la fin du concert	0	1000	998
2	0	Pop	Francofolie-La Rochelle	2018-12-24	Pas ce détails suplementaire	15	200	189
6	0	Pop	Nîme	2019-03-03	Pas ce détails suplementaire	18	350	341
3	0	Pop	Toulouse	2019-02-04	Pas ce détails suplementaire	35	500	491
8	0	Flamenco	La Rochelle	2019-03-15	Pas ce détails suplementaire	24	1000	998
9	0	Rap	La Rochelle	2019-04-17	Pas ce détails suplementaire	28	1000	997
1	0	Flamenco	Zénith de Paris	2018-11-19	Danse de flamenco à la fin du concert	40	600	596
10	1	Rock	Revel	2019-06-21	Rock Francais	0	1000	993
\.
...
4	Diez	Marie	Niort	images/profile.jpg
5	Guerrero	johan	PoneyLand	images/ant.png
6	Guerrero	johan	PoneyLand	images/ant.png
7	Durant	Pierre	Saintes	images/1493244446_hollow-knight.jpg
\.
...
3	4	spel7900@gmail.com	1d4d9679c8745010dcf47b249db8a47f0cac3014
6	7	durant.pierre@gmail.com	a94a8fe5ccb19ba61c4c0873d391e987982fbbd3
\.
...
SELECT pg_catalog.setval('public.admininscrit_id_admininscrit_seq', 5, true);
...
SELECT pg_catalog.setval('public.commande_id_commande_seq', 19, true);
...
SELECT pg_catalog.setval('public.concertindex_id_concertindex_seq', 10, true);
...
SELECT pg_catalog.setval('public.personne_id_personne_seq', 7, true);
...
SELECT pg_catalog.setval('public.personneinscrite_id_personneinscrite_seq', 7, true);
