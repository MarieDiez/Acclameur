...
1	1	Flamenco	Zénith de Paris	2018-11-19	Danse de flamenco à la fin du concert	40	600	600
2	0	Pop	Francofolie-La Rochelle	2018-12-24	Pas ce détails suplementaire	15	200	200
...
8	0	Flamenco	La Rochelle	2019-03-15	Pas ce détails suplementaire	24	1000	1000
9	0	Rap	La Rochelle	2019-04-17	Pas ce détails suplementaire	28	1000	1000
6	0	Pop	Nîme	2019-03-03	Pas ce détails suplementaire	18	350	347
3	0	Pop	Toulouse	2019-02-04	Pas ce détails suplementaire	35	500	499
...
SELECT pg_catalog.setval('public.admininscrit_id_admininscrit_seq', 3, true);
...
SELECT pg_catalog.setval('public.commande_id_commande_seq', 4, true);
...
SELECT pg_catalog.setval('public.personne_id_personne_seq', 4, true);
...
SELECT pg_catalog.setval('public.personneinscrite_id_personneinscrite_seq', 3, true);
